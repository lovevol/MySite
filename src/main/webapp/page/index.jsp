...
<div style="height: 100%;float: left;width: 50%;margin-left: 20px;">
    <c:forEach items="${requestScope.articles}" var="article" varStatus="articleStatus">
        <div style="padding: 20px" class="mydiv">
            ...
            <h5 style="text-align: center">日期:${article.date}&nbsp;&nbsp;&nbsp;<span>标签:<a href="javascript:getArticleByLabelId('${article.label.idLabel}','${article.label.name}');" style="color: #f3726d">${article.label.name}</a></span></h5>
            <br>
